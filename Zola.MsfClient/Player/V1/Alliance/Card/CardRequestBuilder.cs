...
namespace Zola.MsfClient.Player.V1.Alliance.Card {
    /// <summary>
    /// Builds and executes requests for operations under \player\v1\alliance\card
    /// </summary>
    public class CardRequestBuilder : BaseRequestBuilder {
        ...
        public CardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/player/v1/alliance/card{?lang*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CardRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CardRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/player/v1/alliance/card{?lang*}", rawUrl) {
        }
        /// <summary>
        /// Gets a player&apos;s alliance&apos;s card.
        /// </summary>
...
#nullable restore
        ...
        /// Gets a player&apos;s alliance&apos;s card.
        /// </summary>
        public class CardRequestBuilderGetQueryParameters {
...
#nullable restore
        ...
        public class CardRequestBuilderGetRequestConfiguration {
            ...
            public CardRequestBuilderGetQueryParameters QueryParameters { get; set; } = new CardRequestBuilderGetQueryParameters();
            /// <summary>

...
namespace Zola.MsfClient.Models {
    /// <summary>
    /// Achieved if all enemies are dead.
    /// </summary>
    public class CombatObjectives_killAll : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new CombatObjectives_killAll and sets the default values.
        /// </summary>
        public CombatObjectives_killAll() {
        ...
        public static CombatObjectives_killAll CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CombatObjectives_killAll();
        }
        /// <summary>

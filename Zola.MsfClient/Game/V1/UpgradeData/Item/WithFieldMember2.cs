...
namespace Zola.MsfClient.Game.V1.UpgradeData.Item {
    public class WithFieldMember2 : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new WithFieldMember2 and sets the default values.
        /// </summary>
        public WithFieldMember2() {
        ...
        public static WithFieldMember2 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WithFieldMember2();
        }
        /// <summary>

...
namespace Zola.MsfClient.Game.V1.UpgradeData.Item {
    public class WithFieldMember4 : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new WithFieldMember4 and sets the default values.
        /// </summary>
        public WithFieldMember4() {
        ...
        public static WithFieldMember4 CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WithFieldMember4();
        }
        /// <summary>

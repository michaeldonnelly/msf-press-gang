...
namespace Zola.MsfClient.Game.V1.UpgradeData {
    public class UpgradeDataResponse_data_abilityUpgradeCosts : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new upgradeDataResponse_data_abilityUpgradeCosts and sets the default values.
        /// </summary>
        public UpgradeDataResponse_data_abilityUpgradeCosts() {
        ...
        public static UpgradeDataResponse_data_abilityUpgradeCosts CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UpgradeDataResponse_data_abilityUpgradeCosts();
        }
        /// <summary>

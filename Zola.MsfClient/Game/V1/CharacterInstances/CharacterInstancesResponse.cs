...
namespace Zola.MsfClient.Game.V1.CharacterInstances {
    public class CharacterInstancesResponse : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new characterInstancesResponse and sets the default values.
        /// </summary>
        public CharacterInstancesResponse() {
        ...
        public static CharacterInstancesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CharacterInstancesResponse();
        }
        /// <summary>

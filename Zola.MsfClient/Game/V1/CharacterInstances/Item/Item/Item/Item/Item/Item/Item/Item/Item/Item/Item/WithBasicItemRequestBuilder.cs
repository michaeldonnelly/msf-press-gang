...
namespace Zola.MsfClient.Game.V1.CharacterInstances.Item.Item.Item.Item.Item.Item.Item.Item.Item.Item.Item {
    /// <summary>
    /// Builds and executes requests for operations under \game\v1\characterInstances\{level}\{yellow}\{red}\{gearTier}\{slot0}\{slot1}\{slot2}\{slot3}\{slot4}\{slot4}\{basic}
    /// </summary>
    public class WithBasicItemRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Zola.MsfClient.game.v1.characterInstances.item.item.item.item.item.item.item.item.item.item.item.item collection</summary>
        ...
        public WithBasicItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/characterInstances/{level}/{yellow}/{red}/{gearTier}/{slot0}/{slot1}/{slot2}/{slot3}/{slot4}/{slot4}/{basic}{?lang*,statsFormat*,itemFormat*,traitFormat*,mission*,charInfo*,abilityKits*,gearTiers*,pieceInfo*,pieceDirectCost*,pieceFlatCost*,subPieceInfo*,basic*,special*,ultimate*,passive*,iso8*,stark*,war*,quantityFormat*,page*,perPage*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithBasicItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithBasicItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/characterInstances/{level}/{yellow}/{red}/{gearTier}/{slot0}/{slot1}/{slot2}/{slot3}/{slot4}/{slot4}/{basic}{?lang*,statsFormat*,itemFormat*,traitFormat*,mission*,charInfo*,abilityKits*,gearTiers*,pieceInfo*,pieceDirectCost*,pieceFlatCost*,subPieceInfo*,basic*,special*,ultimate*,passive*,iso8*,stark*,war*,quantityFormat*,page*,perPage*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WithBasicResponse?> GetAsync(Action<WithBasicItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WithBasicResponse> GetAsync(Action<WithBasicItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<WithBasicResponse>(requestInfo, WithBasicResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Gets information about a specific requested instance of a specific character.Any *one* of level, yellow, red, or gearTier can be set to &quot;all&quot;. In this case, an array of CharacterInstance objects will be returned, where only the following fields are filled in on each object: the stats field, the power field, the field set to &quot;all&quot;, and any fields which depend on that (for example, asking for &quot;max&quot; ultimate for &quot;all&quot; gear tiers).
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<WithBasicItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<WithBasicItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new WithBasicItemRequestBuilderGetRequestConfiguration();
        ...
        /// Gets information about a specific requested instance of a specific character.Any *one* of level, yellow, red, or gearTier can be set to &quot;all&quot;. In this case, an array of CharacterInstance objects will be returned, where only the following fields are filled in on each object: the stats field, the power field, the field set to &quot;all&quot;, and any fields which depend on that (for example, asking for &quot;max&quot; ultimate for &quot;all&quot; gear tiers).
        /// </summary>
        public class WithBasicItemRequestBuilderGetQueryParameters {
...
#nullable restore
        ...
        /// </summary>
        public class WithBasicItemRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public WithBasicItemRequestBuilderGetQueryParameters QueryParameters { get; set; } = new WithBasicItemRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new WithBasicItemRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public WithBasicItemRequestBuilderGetRequestConfiguration() {

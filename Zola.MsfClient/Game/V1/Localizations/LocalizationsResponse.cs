...
namespace Zola.MsfClient.Game.V1.Localizations {
    public class LocalizationsResponse : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public static LocalizationsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {

...
using System;
using Zola.MsfClient.Game.V1.Events.Item;
using Zola.MsfClient.Models;
namespace Zola.MsfClient.Game.V1.Events {
    /// <summary>
    /// Builds and executes requests for operations under \game\v1\events
    /// </summary>
    public class EventsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Zola.MsfClient.game.v1.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/events{?lang*,statsFormat*,itemFormat*,traitFormat*,type*,eventInfo*,pieceInfo*,quantityFormat*,page*,perPage*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EventsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/events{?lang*,statsFormat*,itemFormat*,traitFormat*,type*,eventInfo*,pieceInfo*,quantityFormat*,page*,perPage*}", rawUrl) {
        }
        /// <summary>
        /// Gets information about scheduled, running, and past events.
        /// </summary>

...
namespace Zola.MsfClient.Game.V1.Traits {
    public class TraitsResponse : IAdditionalDataHolder, IParsable {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The data property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Trait>? Data { get; set; }
#nullable restore
#else
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new traitsResponse and sets the default values.
        /// </summary>
        public TraitsResponse() {
        ...
        public static TraitsResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Trait>(Trait.CreateFromDiscriminatorValue)?.ToList(); } },

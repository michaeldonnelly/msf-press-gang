...
namespace Zola.MsfClient.Game.V1.Raids.Item.Item {
    /// <summary>
    /// Builds and executes requests for operations under \game\v1\raids\{raidId}\{roomId}
    /// </summary>
    public class WithRoomItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithRoomItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/raids/{raidId}/{roomId}{?lang*,itemFormat*,statsFormat*,traitFormat*,nodeInfo*,nodeReqs*,nodeRewards*,pieceInfo*,raidMap*,difficulty*,nodeCombat*,charInfo*,quantityFormat*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithRoomItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRoomItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/raids/{raidId}/{roomId}{?lang*,itemFormat*,statsFormat*,traitFormat*,nodeInfo*,nodeReqs*,nodeRewards*,pieceInfo*,raidMap*,difficulty*,nodeCombat*,charInfo*,quantityFormat*}", rawUrl) {
        }
        /// <summary>
        /// Gets node information about a room in a raid.
        /// </summary>

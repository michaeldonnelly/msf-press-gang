...
namespace Zola.MsfClient.Game.V1.UpgradeData {
    public class UpgradeDataResponse_data_iso8FuseCosts : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new upgradeDataResponse_data_iso8FuseCosts and sets the default values.
        /// </summary>
        public UpgradeDataResponse_data_iso8FuseCosts() {
        ...
        public static UpgradeDataResponse_data_iso8FuseCosts CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UpgradeDataResponse_data_iso8FuseCosts();
        }
        /// <summary>

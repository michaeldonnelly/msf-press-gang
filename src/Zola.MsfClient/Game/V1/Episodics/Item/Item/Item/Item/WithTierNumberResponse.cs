...
namespace Zola.MsfClient.Game.V1.Episodics.Item.Item.Item.Item {
    public class WithTierNumberResponse : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new WithTierNumberResponse and sets the default values.
        /// </summary>
        public WithTierNumberResponse() {
        ...
        public static WithTierNumberResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WithTierNumberResponse();
        }
        /// <summary>

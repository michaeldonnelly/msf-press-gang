...
namespace Zola.MsfClient.Game.V1.OrbRewards.Item {
    /// <summary>
    /// Builds and executes requests for operations under \game\v1\orbRewards\{itemId}
    /// </summary>
    public class WithItemItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/orbRewards/{itemId}{?lang*,itemFormat*,statsFormat*,pieceInfo*,pieceDirectCost*,pieceFlatCost*,subPieceInfo*,quantityFormat*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithItemItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithItemItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/orbRewards/{itemId}{?lang*,itemFormat*,statsFormat*,pieceInfo*,pieceDirectCost*,pieceFlatCost*,subPieceInfo*,quantityFormat*}", rawUrl) {
        }
        /// <summary>
        /// Gets the possible rewards for the requested orb.Returns `NOT_FOUND` if `itemId` is not the id of an orb item (`isOrb` true).
        /// </summary>

...
namespace Zola.MsfClient.Game.V1.Dds.Item {
    public class WithDdResponse : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new WithDdResponse and sets the default values.
        /// </summary>
        public WithDdResponse() {
        ...
        public static WithDdResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WithDdResponse();
        }
        /// <summary>

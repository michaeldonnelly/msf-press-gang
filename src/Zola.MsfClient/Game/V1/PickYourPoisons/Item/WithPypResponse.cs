...
namespace Zola.MsfClient.Game.V1.PickYourPoisons.Item {
    public class WithPypResponse : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new WithPypResponse and sets the default values.
        /// </summary>
        public WithPypResponse() {
        ...
        public static WithPypResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WithPypResponse();
        }
        /// <summary>

...
#nullable enable
        public List<CharacterInfo>? Data { get; set; }
#nullable restore
#else
        public List<CharacterInfo> Data { get; set; }
#endif
...
#nullable restore
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<CharacterInfo>(CharacterInfo.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<CharacterInfo>("data", Data);

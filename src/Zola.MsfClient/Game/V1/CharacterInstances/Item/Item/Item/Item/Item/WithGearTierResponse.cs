...
namespace Zola.MsfClient.Game.V1.CharacterInstances.Item.Item.Item.Item.Item {
    public class WithGearTierResponse : IAdditionalDataHolder, IParsable {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The data property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public WithGearTier? Data { get; set; }
#nullable restore
#else
        public WithGearTier Data { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new WithGearTierResponse and sets the default values.
        /// </summary>
        public WithGearTierResponse() {
        ...
        public static WithGearTierResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WithGearTierResponse();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetObjectValue<WithGearTier>(WithGearTier.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<WithGearTier>("data", Data);
        ...
        /// </summary>
        public class WithGearTier : IAdditionalDataHolder, IParsable {
            /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
            public IDictionary<string, object> AdditionalData { get; set; }
...
#nullable restore
...
#endif
            /// <summary>
            /// Instantiates a new WithGearTier and sets the default values.
            /// </summary>
            public WithGearTier() {
                AdditionalData = new Dictionary<string, object>();
            }
            ...
            /// </summary>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static WithGearTier CreateFromDiscriminatorValue(IParseNode parseNode) {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new WithGearTier();

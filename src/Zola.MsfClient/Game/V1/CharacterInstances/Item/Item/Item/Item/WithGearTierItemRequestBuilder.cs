...
namespace Zola.MsfClient.Game.V1.CharacterInstances.Item.Item.Item.Item {
    /// <summary>
    /// Builds and executes requests for operations under \game\v1\characterInstances\{level}\{yellow}\{red}\{gearTier}
    /// </summary>
    public class WithGearTierItemRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Zola.MsfClient.game.v1.characterInstances.item.item.item.item.item collection</summary>
        ...
        public WithGearTierItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/characterInstances/{level}/{yellow}/{red}/{gearTier}{?lang*,statsFormat*,itemFormat*,traitFormat*,mission*,trait*,status*,slot0*,slot1*,slot2*,slot3*,slot4*,slot5*,basic*,special*,ultimate*,passive*,iso8*,stark*,war*,quantityFormat*,page*,perPage*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithGearTierItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithGearTierItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/characterInstances/{level}/{yellow}/{red}/{gearTier}{?lang*,statsFormat*,itemFormat*,traitFormat*,mission*,trait*,status*,slot0*,slot1*,slot2*,slot3*,slot4*,slot5*,basic*,special*,ultimate*,passive*,iso8*,stark*,war*,quantityFormat*,page*,perPage*}", rawUrl) {
        }
        /// <summary>

...
namespace Zola.MsfClient.Game.V1.CharacterInstances.Item.Item.Item.Item.Item.Item.Item.Item.Item.Item.Item.Item.Item.Item.Item {
    /// <summary>
    /// Builds and executes requests for operations under \game\v1\characterInstances\{characterId}\{level}\{yellow}\{red}\{gearTier}\{slot0}\{slot1}\{slot2}\{slot3}\{slot4}\{slot5}\{basic}\{special}\{passive}\{passive}
    /// </summary>
    public class WithPassiveItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithPassiveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/characterInstances/{characterId}/{level}/{yellow}/{red}/{gearTier}/{slot0}/{slot1}/{slot2}/{slot3}/{slot4}/{slot5}/{basic}/{special}/{passive}/{passive}{?lang*,statsFormat*,itemFormat*,traitFormat*,mission*,charInfo*,abilityKits*,gearTiers*,pieceInfo*,pieceDirectCost*,pieceFlatCost*,subPieceInfo*,iso8*,stark*,war*,quantityFormat*,page*,perPage*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithPassiveItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithPassiveItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/characterInstances/{characterId}/{level}/{yellow}/{red}/{gearTier}/{slot0}/{slot1}/{slot2}/{slot3}/{slot4}/{slot5}/{basic}/{special}/{passive}/{passive}{?lang*,statsFormat*,itemFormat*,traitFormat*,mission*,charInfo*,abilityKits*,gearTiers*,pieceInfo*,pieceDirectCost*,pieceFlatCost*,subPieceInfo*,iso8*,stark*,war*,quantityFormat*,page*,perPage*}", rawUrl) {
        }
        /// <summary>

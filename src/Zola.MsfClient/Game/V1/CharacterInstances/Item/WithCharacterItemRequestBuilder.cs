...
using System;
using Zola.MsfClient.Game.V1.CharacterInstances.Item.Item;
using Zola.MsfClient.Models;
namespace Zola.MsfClient.Game.V1.CharacterInstances.Item {
    /// <summary>
    /// Builds and executes requests for operations under \game\v1\characterInstances\{characterId}
    /// </summary>
    public class WithCharacterItemRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Zola.MsfClient.game.v1.characterInstances.item.item collection</summary>
        public WithLevelItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("level", position);
        ...
        public WithCharacterItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/characterInstances/{characterId}{?lang*,statsFormat*,itemFormat*,traitFormat*,mission*,charInfo*,abilityKits*,gearTiers*,pieceInfo*,pieceDirectCost*,pieceFlatCost*,subPieceInfo*,level*,yellow*,red*,gearTier*,slot0*,slot1*,slot2*,slot3*,slot4*,slot5*,basic*,special*,ultimate*,passive*,iso8*,stark*,war*,quantityFormat*,page*,perPage*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCharacterItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCharacterItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/game/v1/characterInstances/{characterId}{?lang*,statsFormat*,itemFormat*,traitFormat*,mission*,charInfo*,abilityKits*,gearTiers*,pieceInfo*,pieceDirectCost*,pieceFlatCost*,subPieceInfo*,level*,yellow*,red*,gearTier*,slot0*,slot1*,slot2*,slot3*,slot4*,slot5*,basic*,special*,ultimate*,passive*,iso8*,stark*,war*,quantityFormat*,page*,perPage*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<WithCharacterResponse> GetAsync(Action<WithCharacterItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<WithCharacterResponse>(requestInfo, WithCharacterResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Gets information about a specific requested instance of a specific character.Any *one* of level, yellow, red, or gearTier can be set to &quot;all&quot;. In this case, an array of CharacterInstance objects will be returned, where only the following fields are filled in on each object: the stats field, the power field, the field set to &quot;all&quot;, and any fields which depend on that (for example, asking for &quot;max&quot; ultimate for &quot;all&quot; gear tiers).
        /// </summary>

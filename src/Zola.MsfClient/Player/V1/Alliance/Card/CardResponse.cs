...
namespace Zola.MsfClient.Player.V1.Alliance.Card {
    public class CardResponse : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>Information about an alliance.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AllianceCard? Data { get; set; }
#nullable restore
#else
        public AllianceCard Data { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new cardResponse and sets the default values.
        /// </summary>
        public CardResponse() {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetObjectValue<AllianceCard>(AllianceCard.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<AllianceCard>("data", Data);

...
namespace Zola.MsfClient.Player.V1.Inventory {
    public class InventoryResponse : IAdditionalDataHolder, IParsable {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The data property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ItemQuantity>? Data { get; set; }
#nullable restore
#else
        public List<ItemQuantity> Data { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new inventoryResponse and sets the default values.
        /// </summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"data", n => { Data = n.GetCollectionOfObjectValues<ItemQuantity>(ItemQuantity.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ItemQuantity>("data", Data);

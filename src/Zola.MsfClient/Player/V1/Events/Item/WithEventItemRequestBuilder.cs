...
namespace Zola.MsfClient.Player.V1.Events.Item {
    /// <summary>
    /// Builds and executes requests for operations under \player\v1\events\{eventId}
    /// </summary>
    public class WithEventItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithEventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/player/v1/events/{eventId}{?lang*,statsFormat*,itemFormat*,traitFormat*,eventInfo*,objRewards*,pieceInfo*,quantityFormat*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithEventItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithEventItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/player/v1/events/{eventId}{?lang*,statsFormat*,itemFormat*,traitFormat*,eventInfo*,objRewards*,pieceInfo*,quantityFormat*}", rawUrl) {
        }
        /// <summary>
        /// Gets information about an event including a player&apos;s progress on that event.
        /// </summary>
